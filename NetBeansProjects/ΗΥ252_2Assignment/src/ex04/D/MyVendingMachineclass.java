...
public class MyVendingMachineclass implements VendingMachine_ADT{
    ...
    /*NEEDED FUNCTIONS FORM YOUR CLASS*/
 ...
 * @author yannakis
 */
/*public class MyVendingMachineclass {
    private final double money; // money entered
    private final String drink, state; //drink selected and current State
    private final int stock; // drink stock
